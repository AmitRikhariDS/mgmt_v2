...
urlpatterns = [
    ...
    path('manager/real-time-dashboard/', views.manager_job_updates_real_time, name='manager_real_time_dashboard'),
    path('engineer/', views.engineer_dashboard, name='engineer_dashboard'),
    ...
    path('engineer/jobs/<int:job_id>/', views.job_detail, name='job_detail'),
